...
巡回中のハンターが、警戒エリアへ入る前から印象に残るように、壁、巡回地点、`HunterLight`の配置を調整してください。

例えば、巡回するハンターが中央の通路を横切って見えるようにします。

通常色で巡回する姿と、警戒エリアへ入ったあとの赤いライトの違いが分かれば完成です。

<Hint>

`PlayerStart`から見たとき、ハンターの巡回ルートが壁で隠れすぎていないか確認します。

</Hint>

<Answer>

巡回地点を左右に離し、ハンターが中央の通路の奥を横切るようにすると、Play直後から動きを確認できます。

そのあと警戒エリアへ入ってライトが赤くなれば、巡回から追跡への変化も分かりやすくなります。
